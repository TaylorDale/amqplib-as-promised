...
export declare class Channel extends EventEmitter {
    ...
    sendToQueue(queueName: string, content: Buffer, options?: Options.Publish): Promise<unknown>;
    ...
    publish(exchange: string, queue: string, content: Buffer, options?: Options.Publish): Promise<unknown>;
